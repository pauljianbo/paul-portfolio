...
type SectionTheme = 'home' | 'skills' | 'projects' | 'experience' | 'contact';
 ...
 *
 * A global background that covers the entire viewport and dynamically changes themes
 * based on scroll position to eliminate white flickering between sections.
 */
